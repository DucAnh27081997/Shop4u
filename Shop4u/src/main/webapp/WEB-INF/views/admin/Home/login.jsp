...
<title>Admin SHOP4U | Log in</title>
...
<!-- iCheck -->
<link rel="stylesheet" href="<c:url value='/template/admin/plugins/iCheck/square/blue.css"'/>">
...
<body>
	...
	<div class="login-box">
		<div class="login-logo">
			<a href="../../index2.html"><b>Admin</b>SHOP4U</a>
		</div>
		<!-- /.login-logo -->
